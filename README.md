...
User-facing execution context lives in a project-local `AGENTS.md` generated by `media-tooling-init`. Developer-only maintenance notes and quality gates live in [`docs/DEVELOPMENT.md`](./docs/DEVELOPMENT.md).
